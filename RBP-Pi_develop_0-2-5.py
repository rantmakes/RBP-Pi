...
# ============================ SMART MONKEY PATCH ==============================
# ==============================================================================
# Captures Bluetooth objects and applies the Humidity Descriptor Fix
...
class HardwareInterface:
    ...
    def init_sensors(self):
        logging.info("Initializing Hardware Sensors (Shared I2C Bus)...")

        # --- Initialize Shared I2C Bus ---
        try:
            # This uses the default SCL/SDA pins (GPIO 3 and 2)
            i2c = board.I2C()
        except Exception as e:
	...
	# --- 1. MCP9600 (Bean Temp) ---
        try:
            # Force address 0x67 (or whatever i2cdetect showed you)
...
if __name__ == "__main__":
    ...
    # Humidity (Trigger descriptor fix)
    ...
    logging.info("Starting RoastProbe (Shared Bus)...")
    try:
        ble_server.publish() 
