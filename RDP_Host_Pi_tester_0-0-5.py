...
# --- Network Configuration (Matches Working Script 0-0-14) ---
...
class MockProbeHost:
    def __init__(self):
        ...
        # We switch back to Multicast logic here to be consistent
    ...
    def send_syn(self):
        ...
        datagram = {
            ...
            # CRITICAL FIX: Double Encoded Payload (Matches 0-0-14.py)
    ...
    def send_temps(self):
        ...
        for item in sensor_data:
            # FIX: Format Value as String (Matches 0-0-14.py)
