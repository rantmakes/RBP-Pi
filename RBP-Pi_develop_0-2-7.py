...
SERIAL_NUMBER = "12345"
UPDATE_RATE_MS = 2000  # SLOWED DOWN to 2 seconds to prevent bus congestion
...
class HardwareInterface:
    ...
    def init_sensors(self):
        ...
        try:
            # We rely on OS config for speed. We do NOT use busio here to avoid conflicts.
            i2c = board.I2C()
            ...
            try:
                ...
                logging.error(" - MCP9600 Not Found (Address Mismatch)")
            except Exception as e:
    ...
    def update_sensors(self):
        ...
        for probe in self.probes:
            try:
                # SKIP check for data_ready to prevent I2C flooding
                # Just try to read. If it fails, catch it.
                ...
                # Log only critical errors, ignore transient I2C noise
                pass
...
if __name__ == "__main__":
    ...
    # Use the SLOWED DOWN update rate
    async_tools.add_timer_ms(UPDATE_RATE_MS, hw.update_sensors)

    logging.info("Starting RoastProbe (Stable Hardware Mode)...")
    try:
        ble_server.publish() 
