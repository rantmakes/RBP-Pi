...
# --- PINS ---
# MOVED LED to GPIO 19 to avoid I2C conflict on D2
PIN_LED_RED  = 19  # Connect to Button LED (+)
PIN_SHUTDOWN = 26  # Connect to Button Switch (One side)
PIN_ZCD      = 17  
PIN_FAN      = 27  
PIN_HEATER   = 22
...
HEATER_CURVE = [(0.8, 9.0), (2.1, 5.0), (2.9, 1.0), (8.3, 0.0)]
FAN_CURVE    = [(2.0, 9.0), (3.9, 5.0), (4.7, 1.0), (8.3, 0.0)]
...
class SystemMonitor:
    def __init__(self, shutdown_callback):
        ...
        self.pi.write(PIN_LED_RED, 0) # Start Off
        ...
        self.pi.set_pull_up_down(PIN_SHUTDOWN, pigpio.PUD_UP) # Enable Pull-Up
        self.pi.set_glitch_filter(PIN_SHUTDOWN, 1000) # 1ms debounce
        
        # Listen for Push (Falling Edge) and Release (Rising Edge)
    ...
    def _sd_release(self, gpio, level, tick):
        ...
        press_duration = pigpio.tickDiff(self.shutdown_press_start, tick) / 1000000.0 # Seconds
        
        # If pressed for > 2 seconds, Shutdown
...
class HardwareInterface:
    ...
    def trigger_shutdown(self):
        # Flash LED rapidly to indicate acknowledgment
        if self.sys_mon:
            for _ in range(20):
    ...
    def init_sensors(self):
        # --- 1. System Monitor (Phase + Shutdown + LED) ---
    ...
    def update_sensors(self):
        self.set_led(True) # LED ON during read
        ...
        self.set_led(False) # LED OFF after read (blinking effect)
        return True 
...
if __name__ == "__main__":
    ...
    logging.info("Starting RoastProbe v0.7.0...")
    try:
        ble_server.publish() 
