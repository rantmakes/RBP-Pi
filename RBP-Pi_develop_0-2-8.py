...
SERIAL_NUMBER = "12345"
UPDATE_RATE_MS = 2000 # Keep slow (2s) to prevent bus congestion
...
class HardwareInterface:
    ...
    def init_sensors(self):
        ...
        try:
            # Using board.I2C() which now maps to the robust i2c-gpio overlay
            i2c = board.I2C()
        except Exception as e:
        ...
        # --- 2. SCD-41 (With Safety Stop) ---
        try:
            scd = adafruit_scd4x.SCD4X(i2c)
            
            # SAFETY: Stop measurement first in case it was left running
            # This prevents lockups on script restart
            try:
...
if __name__ == "__main__":
    ...
    logging.info("Starting RoastProbe (Overlay Mode)...")
    try:
        ble_server.publish() 
