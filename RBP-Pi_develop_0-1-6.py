        ...
        for probe in self.probes:
            try:
                ...
                if val is not None:
                    ...
                    try:
                        # Access Service 1 (RBP Sensing)
                        srv = ble_server.services[1] 
                        # Iterate to find matching characteristic UUID
...
if __name__ == "__main__":
    ...
    # 4. Run Loop
    # FIX: Using 'add_timer_ms' based on your traceback
    async_tools.add_timer_ms(UPDATE_RATE_MS, lambda: hw.update_sensors(ble_server))
