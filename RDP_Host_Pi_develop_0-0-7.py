...
class ProbeHost:
    def __init__(self):
        ...
        # --- RESTORED FROM WORKING SCRIPT (0-0-1.py) ---
#        self.send_count = 0  
        ...
        # --- RESTORED NETWORK SETUP FROM WORKING SCRIPT (0-0-1.py) ---
        # We removed the complex 'get_local_ip' and 'IP_MULTICAST_IF' logic 
        # that was causing the connection failures.
    ...
    def send_syn(self):
        # We use a Raw Array here (matches Arduino logic), unlike 0-0-1.py which sent a string
        payload_array = [{ KEY_EVENT_TYPE: EVENT_SYN }]
        
        # Using send_count (Integer) to match 0-0-1.py
        datagram = {
